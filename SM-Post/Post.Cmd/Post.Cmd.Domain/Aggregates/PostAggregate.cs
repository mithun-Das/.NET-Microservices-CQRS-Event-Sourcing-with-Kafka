...
namespace Post.Cmd.Domain.Aggregates
{
    public class PostAggregate : AggregateRoot
    {
        ...
        {
            _id = @event.Id;
            _active = true;  // Why hardcoded binding
        ...
        public void AddComment(string comment, string username)
        {
            if (!_active)
            {
                throw new InvalidOperationException("You can't comment in an inactive post!!!");
            }
        ...
        public void RemoveComment(Guid commentId, string username)
        {
            if (!_active)
            {
                throw new InvalidOperationException("You can't remove comment of an inactive post!!!");
            }
