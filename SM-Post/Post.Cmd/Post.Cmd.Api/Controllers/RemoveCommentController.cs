...
namespace Post.Cmd.Api.Controllers
{
    ...
    public class RemoveCommentController : ControllerBase
    {
        ...
        public async Task<ActionResult> RemoveCommentAsync(Guid id, RemoveCommentCommand command)
        {
            ...
            {
                _logger.Log(LogLevel.Warning, ex, "Couldn't retrieve aggregate, client passed an incorrect comment ID targeting the aggregate");
            ...
            {
                const string SAFE_ERROR_MESSAGE = "Error while processing request to remove comment of post!";
